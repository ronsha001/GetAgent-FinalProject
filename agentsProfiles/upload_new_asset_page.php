                ...
                <div class="select_info_section">
                    ...
                    <div class="select_info">
                        ...
                        <select name="asset_condition" id="asset_condition" required>
                            ...
                            <option value="very_new">חדש מקבלן (לא גרו בו בכלל)</option>
                            <option value="new">חדש (נכס בן עד 5 שנים)</option>
                            <option value="renovated">משופץ (שופץ ב5 השנים האחרונות)</option>
                            <option value="good_condition">במצב שמור (במצב טוב, לא שופץ)</option>
                            <option value="renovate_required">דרוש שיפוץ (זקוק לעבודת שיפוץ)</option>
                        </select>
                    </div>
