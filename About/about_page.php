<?php session_start();
    ...
    if (!isset($_SESSION['first_name']) or empty($_SESSION['first_name'])){
        ...
        if ($_SESSION['is_agent'] == 1) {
            $agent_link = '../agentsProfiles/agent_profile_page.php';
    ...
    <div class="section">
        <div class="container">
            <div class="content-section">
                ...
                <div class="content">
                    <h3>שלום <?php echo $first_name ?>, אתר גט אייג'נט הינו אתר אשר מכיל מאגר של נכסים, סוכני וסוכנויות נדל"ן בכל הארץ.</h3>
                    ...
                    <p>על מנת להשאיר חוות דעת על סוכנות/סוכנות - חובה להתחבר לחשבון האישי.<br>על מנת לפתוח פרופיל סוכן - חובה להתחבר לחשבון האישי.<br>על מנת לפרסם נכסים - חובה לפתוח פרופיל סוכן/סוכנות.</p>
                    <div class="button">
